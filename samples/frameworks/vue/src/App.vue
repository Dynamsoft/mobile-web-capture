<template>
	<div class="mwc-hello-world-page">
		<div class="mwc-title">
			<h2 class="mwc-title-text">Hello World for Vue</h2>
			<img class="mwc-title-logo" src="./assets/logo.svg" alt="logo" />
		</div>
	</div>
</template>
